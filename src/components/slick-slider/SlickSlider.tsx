...
export default function SlickSlider({ data, genre }: SlickSliderProps) {
  ...
  /**
   * CORREÇÃO: Removido o 'async' da função beforeChange.
   * O react-slick espera uma função que retorne 'void'. Funções 'async' retornam 'Promise',
   * o que causava o erro de tipagem no TypeScript.
   */
  ...
  const settings: Settings = {
    ...
    slidesToShow: 6,
    slidesToScroll: 6,
    beforeChange, // Agora a tipagem está correta
    responsive: [
      {
        breakpoint: 1536,
        settings: {
